...
saveRDS(sce.enhanced,"out/object/test_sce.enhanced_V07.rds")
saveRDS(sce,"out/object/test_sce_V07.rds")

sce.enhanced <- readRDS("out/object/test_sce.enhanced_V07.rds")
sce <- readRDS("out/object/test_sce_V07.rds")
