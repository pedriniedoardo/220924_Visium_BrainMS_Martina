...
data_dir <- "../../../raw_data/spaceranger_out/03_SP1/outs/"
...
ggsave("out/image/01_ncount_V03.pdf",width = 10,height = 5)
...
ggsave("out/image/02_GOI_V03.pdf",width = 20,height = 20)
...
p1
ggsave("out/image/03_V03_p1.pdf",width = 20,height = 20)

p2
ggsave("out/image/03_V03_p2.pdf",width = 20,height = 20)
...
p1 + p2
ggsave("out/image/04_UMAP_V03.pdf",width = 10,height = 5)
...
ggsave("out/image/05_PanelClusters_V03.pdf",width = 15,height = 15)

SpatialDimPlot(brain, cells.highlight = CellsByIdentities(object = brain, idents = c(0:8)), facet.highlight = TRUE, ncol = 3,alpha = 0.5)
ggsave("out/image/05_PanelClusters2_V03.pdf",width = 15,height = 15)
...
df_res %>% 
  write_tsv("out/table/V03_FindMarkers.tsv")
...
pmap(list(list_res,names(list_res)), function(x,name){
  name_plot <- paste0("out/image/06_TopCluster_V03_",name,".pdf")
...
# ggsave("out/image/06_TopCluster2_V03.pdf",width = 15,height = 15)
...
ggsave(filename = "out/image/07_TopSpatialVariableFeatures_V03.pdf",width = 20,height = 20)

# since the computation is quite intense save the object up to this poing
# brain <- readRDS("../out_large/brain_V03.rds")
saveRDS(brain,"../out_large/brain_V03.rds")
...
ggsave("out/image/07_CCA_label_transfer_V03.pdf",width = 15,height = 15)
...
ggsave("out/image/07_CCA_label_transfer2_V03.pdf",width = 15,height = 15)
