...
brain <- readRDS("../out_large/brain_V05.rds")
...
saveRDS(object = spotlight_ls, file = "out/object/spotlight_ls_V05.rds")


# Read RDS object ---------------------------------------------------------
# spotlight_ls <- readRDS(file = "out/object/spotlight_ls_V05.rds")
...
brain@meta.data %>% 
  ...
  write_tsv("out/table/V05_SPOTLight.tsv")
...
Seurat::SpatialFeaturePlot(
  ...
  alpha = c(0.1, 1))
ggsave("out/image/01_spotlight_deconvolution_panel_V05.pdf",width = 15,height = 10)

Seurat::SpatialFeaturePlot(
  object = brain,
  features = c("AST", "IMM", "NEU", "OLIGO","OPC","VAS","LYM"),
  alpha = c(0.1, 1))
ggsave("out/image/01_spotlight_deconvolution_panel_V05_test.pdf",width = 15,height = 10)
...
spatial_scatterpie(se_obj = brain,
                   ...
                   img_path = "../../../raw_data/spaceranger_out/05_SP1/outs/spatial/tissue_lowres_image.png",
                   pie_scale = 0.4)
ggsave("out/image/01_spotlight_deconvolution_piechart_V05.pdf",width = 5,height = 5)
