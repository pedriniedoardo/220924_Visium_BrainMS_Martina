...
data_dir <- "../../../raw_data/spaceranger_out/05_SP1/outs/"
...
ggsave("out/image/01_ncount_V05.pdf",width = 10,height = 5)
...
SpatialFeaturePlot(brain, features = c("SPP1", "MBP","IGHG1","CD8A","CD68","C3","C1QB"))
ggsave("out/image/02_GOI_V05.pdf",width = 20,height = 20)
...
p1 <- SpatialFeaturePlot(brain, features = c("SPP1", "MBP","IGHG1","CD8A","CD68","C3","C1QB"), pt.size.factor = 1)
p2 <- SpatialFeaturePlot(brain, features = c("SPP1", "MBP","IGHG1","CD8A","CD68","C3","C1QB"), alpha = c(0.1, 1))
p1
ggsave("out/image/03_V05_p1.pdf",width = 20,height = 20)

p2
ggsave("out/image/03_V05_p2.pdf",width = 20,height = 20)
...
brain <- FindClusters(brain, verbose = FALSE,resolution = 0.6)
...
p1 + p2
ggsave("out/image/04_UMAP_V05.pdf",width = 10,height = 5)
...
ggsave("out/image/05_PanelClusters_V05.pdf",width = 15,height = 15)

SpatialDimPlot(brain, cells.highlight = CellsByIdentities(object = brain, idents = c(0:8)), facet.highlight = TRUE, ncol = 3,alpha = 0.5)
ggsave("out/image/05_PanelClusters2_V05.pdf",width = 15,height = 15)
...
ggsave("out/image/06_TopCluster3_V05.pdf",width = 15,height = 15)
...
ggsave("out/image/06_TopCluster2_V05.pdf",width = 15,height = 15)
...
saveRDS(brain,"../out_large/brain_V05.rds")
...
ggsave("out/image/07_CCA_label_transfer_V05.pdf",width = 15,height = 15)
#
