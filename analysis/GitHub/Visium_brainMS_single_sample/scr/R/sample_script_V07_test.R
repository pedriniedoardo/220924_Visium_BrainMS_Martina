...
data_dir <- "../../../raw_data/spaceranger_out/07_SP1/outs/"
...
ggsave("out/image/01_ncount_V07.pdf",width = 10,height = 5)
...
ggsave("out/image/02_GOI_V07.pdf",width = 20,height = 20)
...
p1
ggsave("out/image/03_V07_p1.pdf",width = 20,height = 20)

p2
ggsave("out/image/03_V07_p2.pdf",width = 20,height = 20)
...
p1 + p2
ggsave("out/image/04_UMAP_V07.pdf",width = 10,height = 5)
...
ggsave("out/image/05_PanelClusters_V07.pdf",width = 15,height = 15)

SpatialDimPlot(brain, cells.highlight = CellsByIdentities(object = brain, idents = c(0:8)), facet.highlight = TRUE, ncol = 3,alpha = 0.5)
ggsave("out/image/05_PanelClusters2_V07.pdf",width = 15,height = 15)
...
de_markers1 <- FindMarkers(brain, ident.1 = 1,logfc.threshold = 0,only.pos = T)
SpatialFeaturePlot(object = brain, features = rownames(de_markers1)[1:9], alpha = c(0.1, 1), ncol = 3)
ggsave("out/image/06_TopCluster1_V07.pdf",width = 15,height = 15)
...
ggsave("out/image/06_TopCluster2_V07.pdf",width = 15,height = 15)

de_markers3 <- FindMarkers(brain, ident.1 = 3,logfc.threshold = 0,only.pos = T)
SpatialFeaturePlot(object = brain, features = rownames(de_markers3)[1:9], alpha = c(0.1, 1), ncol = 3)
ggsave("out/image/06_TopCluster3_V07.pdf",width = 15,height = 15)

de_markers7 <- FindMarkers(brain, ident.1 = 7,logfc.threshold = 0,only.pos = T)
SpatialFeaturePlot(object = brain, features = rownames(de_markers7)[1:9], alpha = c(0.1, 1), ncol = 3)
ggsave("out/image/06_TopCluster7_V07.pdf",width = 15,height = 15)
...
saveRDS(brain,"../out_large/brain_V07.rds")
...
ggsave("out/image/07_CCA_label_transfer_V07.pdf",width = 15,height = 15)
...
ggsave("out/image/07_CCA_label_transfer2_V07.pdf",width = 15,height = 15)
