# AIM ---------------------------------------------------------------------
# deconvolve with the classification of the imm subclusters annotation
...
saveRDS(object = spotlight_ls, file = "out/object/spotlight_ls.rds")


# Read RDS object ---------------------------------------------------------
spotlight_ls <- readRDS(file = "out/object/spotlight_ls.rds")
...
brain@meta.data %>% 
  ...
  write_tsv("out/table/V01_SPOTLight.tsv")
