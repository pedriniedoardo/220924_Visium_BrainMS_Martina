# AIM ---------------------------------------------------------------------
# test run the CellChat v2 on slide V1
...
SpatialDimPlot(test, label = T, label.size = 3,group.by = "manual_segmentation")

Idents(test) <- "manual_segmentation"
...
saveRDS(cellchat, file = "out/object/100_cellchat_V01.rds")
